...
public class SharedDataWaiterAgent extends WaiterAgent {
	...
	public SharedDataWaiterAgent(String name, AStarTraversal aStar,	Restaurant restaurant, Table[] tables) {
		super(name, aStar, restaurant, tables);
		// Construct the same as a regular waiter agent
	}
	
    protected void giveOrderToCook(MyCustomer customer) { // New method to be used for shared data waiter
